...
namespace TextmagicRest.Tests
{
    ...
    public class MessagesTests
    {
        ...
        private string sessionText = "SCHEDULED API TEST";
        private SendingSource sessionSource = SendingSource.Api;
        private float sessionPrice = 0.074f;
        private int sessionNumbersCount = 1;
